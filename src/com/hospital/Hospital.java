...
public class Hospital {
    ...
    public static void addPatients() {
        ...
        boolean yes = Objects.equals(response, "Yes") || Objects.equals(response, "yes")
        ...
        for (;;) {
            if (yes) {
                ...
                p1.setPatient(name, age, disease, patientDateRecords.getAdmissionDate(),
                        patientDateRecords.getDischargeDate());
            ...
            if (Objects.equals(continueCreate, "No") || Objects.equals(continueCreate, "no")
                    || Objects.equals(continueCreate, "NO")) {
    ...
    public static void main(String[] args) {
        for (;;) {
            Scanner operation = new Scanner(System.in); // Create a Scanner object that will ask the user which
                                                        // operation to carry out
            System.out.println(
                    "What Operation would you want to carry out ?(Use Integer Value to reply) \n 1. Add New Patient \n 2. Remove Patient \n 3. Display Patients  \n 4. Display Patients Below 1 years old ");
